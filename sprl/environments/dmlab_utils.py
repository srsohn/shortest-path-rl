...
class LevelCache:
  def __init__(self, level_name):
    ...
    self._cache_dir = os.path.join(os.getcwd(), 'data', level_name)
...
class DMLabWrapper(gym.Env):
  ...
  def __init__(self, platform, args,
    ...
    Args:
      ...
      args: The environment settings. => env_settings
    ...
    if use_level_cache == True:
      level_cache = LevelCache(level_name)
    elif use_level_cache == False:
      level_cache = None
    else:
      print("Wrong input for use_level_cache")
      raise NotImplementedError

    self._env = deepmind_lab.Lab(
        level_name, observation_format, string_args, renderer, level_cache=level_cache)
